  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      bundle: {
        ...
        src: [
          'tessera/static/js/jquery-1.11.2.js',
          'tessera/static/js/jquery.dataTables.js',
          'tessera/static/js/dataTables.bootstrap.js',
          'tessera/static/js/moment.js',
          'tessera/static/js/moment-timezone-with-data.js',
          'tessera/static/js/marked.js',
          'tessera/static/js/mousetrap.js',
          'tessera/static/js/highlight.pack.js',
          'tessera/static/js/bean.js',
          'tessera/static/js/URI.min.js',
          'tessera/static/js/handlebars.js',
          'tessera/static/js/bootstrap.js',
          'tessera/static/js/bootbox.js',
          'tessera/static/js/d3.js',
          'tessera/static/js/nv.d3.js',
          'tessera/static/js/tagmanager.js',
          'tessera/static/js/select2.js',
          'tessera/static/js/bootstrap-editable.js',
          'tessera/static/js/bootstrap-growl.min.js',
          'tessera/static/js/bootstrap-datetimepicker.js',
